      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center p-6">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-200">
            Computer Science graduate in 2024 passionate about React Native and
            Full-Stack Development. I’ve built projects like a Book Library
            system, Gupio smart parking App, and Trexo Grocery App using
            JavaScript, React, Redux, Firebase, and MongoDB. I’m eager to create
            scalable, user-friendly applications and grow as a software
            developer.
          </p>
